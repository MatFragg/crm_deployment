...
router.post('/products', auth, role(['admin']), productController.uploadImage, productController.newProduct);
...
router.put('/products/:id', auth, role(['admin']), productController.uploadImage, productController.updateProduct);
